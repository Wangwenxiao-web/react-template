...
function LoginPage() {
  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2">
      ...
      <div className="from-primary/90 via-primary to-primary/80 text-primary-foreground relative hidden flex-col justify-between bg-linear-to-br p-12 lg:flex">
        <div className="relative z-20">
          <div className="flex items-center gap-2 text-lg font-semibold">
            <div className="bg-primary-foreground/10 flex size-8 items-center justify-center rounded-lg backdrop-blur-sm">
        ...
        <div className="bg-primary-foreground/10 absolute top-1/4 right-1/4 size-64 rounded-full blur-3xl" />
        <div className="bg-primary-foreground/5 absolute bottom-1/4 left-1/4 size-96 rounded-full blur-3xl" />
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                className="bg-background border-border/60 focus:border-primary h-12"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  required
                  className="bg-background border-border/60 focus:border-primary h-12 pr-10"
                />
                <button
                  type="button"
